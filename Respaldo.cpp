															...
															case 1:
																...
																do{
																	...
																	switch(opc){
																		...
																		case 1:
																			cout<<"\n\tIntento hacer llamadas pero no hay señal en el lugar donde me encuentro\n"<<endl;
																			system("pause");				
																			system("cls");
																			break;
																			
																		case 2:
																			cout<<"\n\tIntento dormir un poco sin lograrlo, la cabeza me hace mucho ruido.\n"<<endl;
																			system("pause");				
																			system("cls");
																			break;
																		
																		case 3:
																			cout<<"\n\tYo creo que esta es la mejor opcion, pero me percato que un ave extraña negra esta viendome desde un arbol\n"<<endl;
																			system("pause");				
																			system("cls");
																			break;
